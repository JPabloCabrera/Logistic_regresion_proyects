# regresion_logistica guide installation
...
To move beyond notebook prototyping, all reusable code should go into the `regresion_logistica/` folder package. To use that package inside your project, install the project's module in editable mode, so you can edit files in the `regresion_logistica` folder and use the modules inside your notebooks :
...
```python
from regresion_logistica.utils.paths import data_dir
data_dir()
```
